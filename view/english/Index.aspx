<%@ Page Title="" Language="C#" MasterPageFile="~/view/Eng/Site1.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="AIAHL.view.Eng.Index" %>
    ...
    <section>
            ...
            <div class="col-md-12">
                <marquee behavior="scroll" direction="left" onmouseover="this.stop();" onmouseout="this.start();">
                    <img src="images/new.gif" />
                          <a style="color:#ff0000; font-weight: bold;"> Welcome to New  AI Assets Holding Limited ('AIAHL') Website .</a>    &nbsp;&nbsp;                                                        
        ...
        <div class="slider">
            <div class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <img src="images/Tiranga2.png" style="height: 430px; float: left; padding: 2px 1px 0px 2px;" title="Tiranga" alt="" />
                </div>

                <div class="item">
                    <img src="../../Assest/Images/Tiranga2.png" style="height: 430px; float: left; padding: 2px 1px 0px 2px;" title="G20 Logo" alt="" />
                </div>



                <div class="item">
                    <img src="../../Assest/Images/CentaurDelhi.jpg" style="height: 430px; float: left; padding: 2px 1px 0px 2px;" title="CentaurDelhi" alt="" />
                </div>
